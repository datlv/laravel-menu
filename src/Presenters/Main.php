...
namespace Datlv\Menu\Presenters;

use Datlv\Menu\Contracts\Presenter;
use Html;
use MenuManager;
...
class Main extends Base implements Presenter
{
     ...
     *
     * @param \Datlv\Menu\Roots\EditableRoot $root
     * @param array $options
     *
     * @return string
     */
    public function html($root, $options = [])
    {
        ...
        /** @var \Datlv\Menu\Menu[]|\Illuminate\Support\Collection $items */
