...
use Datlv\Menu\Roots\UneditableRoot;
use Request;
use Datlv\Menu\Roots\EditableRoot;
...
class Manager
{
     ...
     *
     * @var \Datlv\Menu\Roots\EditableRoot[]
     */
    protected $lists = [];
     ...
     *
     * @return string|\Datlv\Menu\Types\MenuType
     */
     ...
     * @param string $name
     *
     * @return \Datlv\Menu\Roots\EditableRoot|\Datlv\Menu\Roots\UneditableRoot
     */
     ...
     * @param string $title
     *
     * @return \Datlv\Menu\Contracts\Type|\Datlv\Menu\Contracts\Presenter
     */
