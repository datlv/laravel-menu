...
return [
    ...
    'presenters' => [
        'main' => \Datlv\Menu\Presenters\Main::class,
        'list1' => \Datlv\Menu\Presenters\List1::class,
        'list2' => \Datlv\Menu\Presenters\List2::class,
        'metis' => \Datlv\Menu\Presenters\Metis::class,
    ],
    ...
    'types' => [
        'url' => [
            ...
            'icon' => 'external-link',
            'class' => \Datlv\Menu\Types\UrlMenu::class,
        ],
        'route' => [
            'title' => 'trans::menu::type.route.title',
            'icon' => 'link',
            'class' => \Datlv\Menu\Types\RouteMenu::class,
        ],
    ],
