...
/**
 * @author: Minh Bang <contact@Datlv.com>
 */
class UnEditableMenuTest extends TestCase
{
    /**
     * @var \Datlv\Menu\Roots\UneditableRoot;
     */
    protected $root;
    ...
    {
        parent::setUp();
        $this->root = new \Datlv\Menu\Roots\UneditableRoot('test', \Datlv\Menu\Presenters\Metis::class, []);
    }
